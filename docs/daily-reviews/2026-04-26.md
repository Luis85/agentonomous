...
- Not reviewed: `examples/product-demo/src/cognitionSwitcher.ts` (large demo file, 708-line change), `graphify-out/graph.json` (generated, 23k-line artifact), `package-lock.json`, `docs/plans/` doc-only changes
